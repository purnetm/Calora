...
export default function ShopPage() {
  return (
    <div className="w-full bg-[#fafafa]">
      <div className="max-w-[1440px] mx-auto px-4 lg:px-8 py-12 flex flex-col gap-12">
        <div className="text-center flex flex-col gap-4">
          <h1 className="text-4xl font-bold text-[#212121]">Our Menu</h1>
          <p className="text-lg text-[#757575] font-light">Explore our full range of guilt-free treats.</p>
        </div>
